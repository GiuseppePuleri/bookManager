...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav style="background: url('{{ asset('assets/dashboard/images/other/nav-cover.png') }}') center center no-repeat !important; background-size: cover;" class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper navbar-search-wrapper d-none d-lg-flex align-items-center">
                    <form action="{{ route('categories.index') }}" method="GET" class="d-flex align-items-center w-100">
                        ...
                        <ul class="navbar-nav navbar-nav-right d-flex align-items-center">
                            ...
                            <li class="nav-item ms-2">
                                <div class="my-3">
                                    <a href="{{ route('categories.index') }}" class="btn btn-secondary btn-lg font-weight-small">
                                        Reset
                                    </a>
                                </div>
                            </li>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="categoriesTableBody">
                                                ...
                                                <tr data-category-id="{{ $category->id }}">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-warning" onclick="editCategory({{ $category->id }})" title="Modifica">
                                                            <i class="mdi mdi-pencil"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-danger" onclick="deleteCategory({{ $category->id }})" title="Elimina">
    ...
    <script>
        ...
        // URL helper Laravel
        const storeUrl = "{{ route('categories.store') }}"; // POST
        const editUrlBase = "{{ url('categories') }}";      // GET /{id}/edit
        const updateUrlBase = "{{ url('categories') }}";    // PUT /{id}
        const deleteUrlBase = "{{ url('categories') }}";    // DELETE /{id}
