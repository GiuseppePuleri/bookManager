        ...
        <div class="container-fluid padding-side">
            ...
            <div class="header-bottom offcanvas offcanvas-end " id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                ...
                <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                    ...
                    <a class="nav-link active-index p-0" aria-current="page" href="{{ route('showcase.index') }}">Home</a>
                    </li>
                    <li class="nav-item px-3">
                    <a class="nav-link p-0 active-reservations" href="{{ route('showcase.my-reservations') }}">My Reservations</a>
                    </li>
                </ul>
                </div>
            </div>
            
            <a class="navbar-brand" flag="isAdmin" href="{{ route('login', ['isAdmin' => 1]) }}">
