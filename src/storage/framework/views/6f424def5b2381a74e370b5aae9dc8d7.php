...
<link rel="stylesheet" href="<?php echo e(asset('css/dashboard/users.css')); ?>">
...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav style="background: url('<?php echo e(asset('assets/dashboard/images/other/nav-cover.png')); ?>') center center no-repeat !important; background-size: cover;" class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper navbar-search-wrapper d-none d-lg-flex align-items-center">
                    <form action="<?php echo e(route('users.index')); ?>" method="GET" class="d-flex align-items-center w-100">
                        ...
                        <ul class="navbar-nav navbar-nav-right d-flex align-items-center">
                            ...
                            <li class="nav-item ms-2">
                                <div class="my-3">
                                    <a href="<?php echo e(route('users.index')); ?>" class="btn btn-secondary btn-lg font-weight-small">
                                        Reset
                                    </a>
                                </div>
                            </li>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="usersTableBody">
                                                ...
                                                <tr data-user-id="<?php echo e($user->id); ?>">
                                                    ...
                                                    <td>
                                                        <span class="badge <?php echo e($user->role_badge_class); ?>" id="roleBadge<?php echo e($user->id); ?>">
                                                            <?php echo e($user->role_label); ?>

                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-success"><?php echo e($user->active_reservations_count); ?></span>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-info"><?php echo e($user->reservations_count); ?></span>
                                                    </td>
                                                    <td><?php echo e($user->created_at->format('d/m/Y')); ?></td>
                                                    <td>
                                                        <button class="btn btn-sm btn-info" onclick="viewUserDetails(<?php echo e($user->id); ?>)" title="Dettagli e prenotazioni">
                                                            <i class="mdi mdi-eye"></i>
                                                        </button>
                                                        <?php if($user->id !== auth()->id()): ?>
                                                            <button class="btn btn-sm btn-warning" onclick="toggleUserRole(<?php echo e($user->id); ?>)" title="Cambia ruolo">
                                                                <i class="mdi mdi-account-key"></i>
                                                            </button>
                                                            <button class="btn btn-sm btn-primary" onclick="editUser(<?php echo e($user->id); ?>)" title="Modifica utente">
                                                                <i class="mdi mdi-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-sm btn-danger" onclick="deleteUser(<?php echo e($user->id); ?>)" title="Elimina utente">
    ...
    <script>
        ...
        // URL helper Laravel
        const storeUserUrl = "<?php echo e(route('users.store')); ?>";
        const getUserUrlBase = "<?php echo e(url('users')); ?>";
        const updateUserUrlBase = "<?php echo e(url('users')); ?>";
        const deleteUserUrlBase = "<?php echo e(url('users')); ?>";
        const toggleRoleUrlBase = "<?php echo e(url('users')); ?>";
        const getReservationsUrlBase = "<?php echo e(url('users')); ?>";
        const completeReservationUrlBase = "<?php echo e(url('users')); ?>";
        const extendReservationUrlBase = "<?php echo e(url('users')); ?>";
        const cancelReservationUrlBase = "<?php echo e(url('users')); ?>";
...
<?php /**PATH /var/www/resources/views/dashboard/pages/users.blade.php ENDPATH**/ ?>