...
<body>
  ...
  <section id="slider" data-aos="fade-up">
    <div class="container-fluid padding-side">
      <div class="d-flex rounded-5" style="background-image: url('<?php echo e(asset('assets/showcase/images/nav-cover.png')); ?>'); background-size: cover; background-repeat: no-repeat; height: 85vh; background-position: center;">
  ...
  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($categoryBooks->count() > 0): ?>
      <section id="categoria-<?php echo e($category->id); ?>" class="padding-medium">
          <div class="container-fluid padding-side" data-aos="fade-up">
              <div class="d-flex flex-wrap align-items-center justify-content-between">
                  <div>
                      <h3 class="display-3 fw-normal text-left"><?php echo e($category->name); ?></h3>
                      <?php if($category->description): ?>
                          <p class="text-left text-muted"><?php echo e($category->description); ?></p>
                          <br>
                      <?php endif; ?>
                  </div>
              </div>
              ...
              <div class="swiper room-swiper mt-5">
                  <div class="swiper-wrapper">
                      ...
                      <div id="libro-<?php echo e($book->id); ?>" class="swiper-slide">
                          <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
                              ...
                              <div class="product-description position-absolute p-5 text-start">
                                  <h4 class="display-6 fw-normal text-white"><?php echo e($book->title); ?></h4>
                                  <p class="product-paragraph text-white">
                                      <?php echo e(Str::limit($book->description ?? 'Nessuna descrizione disponibile.', 100)); ?>
                                  ...
                                  <table>
                                      <tbody>
                                          ...
                                          <tr class="text-white">
                                              ...
                                              <td><?php echo e($book->year ?? 'N/D'); ?></td>
                                          </tr>
                                          <tr class="text-white">
                                          ...
                                          <tr class="text-white">
                                              ...
                                              <td>
                                                  <span class="badge bg-success"><?php echo e($book->available_copies_count); ?></span>
                                              </td>
                                          </tr>
                                      </tbody>
                                  </table>
                                  ...
                                  <?php if(auth()->guard()->check()): ?>
                                      <button onclick="reserveBook(<?php echo e($book->id); ?>)" 
                                              class="btn btn-light mt-2">
                                          <span>Prenota Ora</span>
                                      </button>
                                  <?php else: ?>
                                      <a href="<?php echo e(route('showcase.my-reservations')); ?>">
                          ...
                          <div class="room-content text-center mt-3">
                              <h4 class="display-6 fw-normal">
                                  <a href="#libro-<?php echo e($book->id); ?>"><?php echo e($book->title); ?></a>
                              </h4>
                              <p>
                                  <span class="text-primary fs-4"><?php echo e($book->author); ?></span>
                                  <?php if($book->year): ?>
  ...
  function reserveBook(bookId) {
      <?php if(auth()->guard()->guest()): ?>
          ...
          window.location.href = "<?php echo e(route('showcase.my-reservations')); ?>";
          return;
      <?php endif; ?>
      ...
      if(confirm('Vuoi prenotare questo libro?')) {
          $.ajax({
              url: "<?php echo e(route('showcase.reserve')); ?>",
              type: 'POST',
              data: { book_id: bookId },
  ...
  <script>
    ...
    document.getElementById('search-form').addEventListener('submit', function(e) {
        ...
        // Chiamata AJAX
        fetch(`<?php echo e(route('showcase.search')); ?>?${params.toString()}`, {
            method: 'GET',
            headers: {
  ...
  <script src="<?php echo e(asset('js/showcase/reservations.js')); ?>"></script>
...
</html><?php /**PATH /var/www/resources/views/showcase/pages/showcase.blade.php ENDPATH**/ ?>