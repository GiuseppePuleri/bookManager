...
<link rel="stylesheet" href="<?php echo e(asset('css/reservations.css')); ?>">
...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav style="background: url('<?php echo e(asset('assets/dashboard/images/other/nav-cover.png')); ?>') center center no-repeat !important; background-size: cover;" class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper navbar-search-wrapper d-none d-lg-flex align-items-center">
                    <form action="<?php echo e(route('reservations.index')); ?>" method="GET" class="d-flex align-items-center w-100">
                        ...
                        <ul class="navbar-nav navbar-nav-right d-flex align-items-center">
                            ...
                            <li class="nav-item me-2">
                                <select name="status" class="form-control">
                                    ...
                                    <option value="active" <?php echo e(request('status') == 'active' ? 'selected' : ''); ?>>Attive (In corso)</option>
                                    <option value="completed" <?php echo e(request('status') == 'completed' ? 'selected' : ''); ?>>Completate (Resi)</option>
                                    <option value="overdue" <?php echo e(request('status') == 'overdue' ? 'selected' : ''); ?>>In Ritardo</option> 
                                    <option value="cancelled" <?php echo e(request('status') == 'cancelled' ? 'selected' : ''); ?>>Annullate</option>
                                </select>
                            </li>
                            ...
                            <li class="nav-item ms-2">
                                <div class="my-3">
                                    <a href="<?php echo e(route('reservations.index')); ?>" class="btn btn-secondary btn-lg font-weight-small">
                                        Reset
                                    </a>
                                </div>
                            </li>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="card bg-primary text-white">
                                        <div class="card-body p-3 text-center">
                                            <h3 class="mb-0" id="statTotal"><?php echo e($stats['total'] ?? null); ?></h3>
                                            <small>Totali</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="card bg-success text-white">
                                        <div class="card-body p-3 text-center">
                                            <h3 class="mb-0" id="statActive"><?php echo e($stats['active'] ?? null); ?></h3>
                                            <small>Attive</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="card bg-danger text-white">
                                        <div class="card-body p-3 text-center">
                                            <h3 class="mb-0" id="statOverdue"><?php echo e($stats['overdue'] ?? null); ?></h3>
                                ...
                                <div class="col-md-2">
                                    <div class="card bg-info text-white">
                                        <div class="card-body p-3 text-center">
                                            <h3 class="mb-0" id="statCompleted"><?php echo e($stats['completed'] ?? null); ?></h3>
                                ...
                                <div class="col-md-2">
                                    <div class="card bg-secondary text-white">
                                        <div class="card-body p-3 text-center">
                                            <h3 class="mb-0" id="statCancelled"><?php echo e($stats['cancelled'] ?? null); ?></h3>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="reservationsTableBody">
                                                ...
                                                ?>
                                                <tr data-reservation-id="<?php echo e($reservation->id); ?>" 
                                                    data-status="<?php echo e($reservation->status); ?>"
                                                    data-user-id="<?php echo e($reservation->user_id); ?>"
                                                    data-overdue="<?php echo e($isOverdue ? '1' : '0'); ?>">
                                                    <td>
                                                        <?php if($reservation->status === 'active'): ?>
                                                            <input type="checkbox" class="reservation-checkbox" value="<?php echo e($reservation->id); ?>">
                                                        <?php endif; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <strong><?php echo e($reservation->bookCopy->book->title); ?></strong><br>
                                                        <small class="text-muted"><?php echo e($reservation->bookCopy->book->author); ?></small>
                                                    </td>
                                                    <td>
                                                        <code><?php echo e($reservation->bookCopy->barcode); ?></code>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-info"><?php echo e($reservation->bookCopy->book->category->name); ?></span>
                                                    </td>
                                                    <td>
                                                        <span class="badge <?php echo e($reservation->status_badge_class); ?>">
                                                            <?php echo e($reservation->status_label); ?>

                                                        </span>
                                                        <?php if($isOverdue): ?>
                                                            <br><small class="text-danger"><?php echo e(abs($reservation->days_overdue)); ?> gg ritardo</small>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><?php echo e($reservation->reserved_at->format('d/m/Y')); ?></td>
                                                    <td class="<?php echo e($dueDateClass); ?>">
                                                        <?php echo e($reservation->due_date->format('d/m/Y')); ?>

                                                        <?php if($reservation->status === 'active' && !$isOverdue): ?>
                                                            <br><small class="text-muted"><?php echo e($reservation->days_until_due); ?> giorni</small>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <?php if($reservation->extended_count > 0): ?>
                                                            <span class="badge badge-warning"><?php echo e($reservation->extended_count); ?></span>
                                                        <?php else: ?>
                                                            -
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <button class="btn btn-sm btn-info" onclick="viewReservationDetails(<?php echo e($reservation->id); ?>)" title="Dettagli">
                                                            <i class="mdi mdi-eye"></i>
                                                        </button>
                                                        <?php if($reservation->status === 'active'): ?>
                                                            <button class="btn btn-sm btn-success" onclick="completeReservation(<?php echo e($reservation->id); ?>)" title="Segna come restituito">
                                                                <i class="mdi mdi-check"></i>
                                                            </button>
                                                            <button class="btn btn-sm btn-warning" onclick="extendReservation(<?php echo e($reservation->id); ?>)" title="Estendi">
                                                                <i class="mdi mdi-clock-outline"></i>
                                                            </button>
                                                            <button class="btn btn-sm btn-danger" onclick="cancelReservation(<?php echo e($reservation->id); ?>)" title="Annulla">
                                                                <i class="mdi mdi-close"></i>
                                                            </button>
                                                        <?php else: ?>
                                                            <button class="btn btn-sm btn-secondary" onclick="deleteReservation(<?php echo e($reservation->id); ?>)" title="Elimina">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="createBookId" onchange="loadAvailableCopies()" required>
                                                ...
                                                <?php $__empty_1 = true; $__currentLoopData = \App\Models\Book::with('category')->orderBy('title')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="createDueDate" name="due_date" 
                                                ...
                                                value="<?php echo e(now()->addDays(14)->format('Y-m-d')); ?>">
    ...
    <script>
        ...
        // URL helper Laravel
        const reservationsIndexUrl = "<?php echo e(route('reservations.index')); ?>";
        const storeReservationUrl = "<?php echo e(route('reservations.store')); ?>";
        const reservationUrlBase = "<?php echo e(url('reservations')); ?>";
        const completeReservationUrlBase = "<?php echo e(url('reservations')); ?>";
        const extendReservationUrlBase = "<?php echo e(url('reservations')); ?>";
        const cancelReservationUrlBase = "<?php echo e(url('reservations')); ?>";
        const bulkActionUrl = "<?php echo e(route('reservations.bulkAction')); ?>";
        const availableCopiesUrlBase = "<?php echo e(url('books')); ?>";
...
<?php /**PATH /var/www/resources/views/dashboard/pages/reservations.blade.php ENDPATH**/ ?>