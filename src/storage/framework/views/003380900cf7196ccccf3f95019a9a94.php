...
<link rel="stylesheet" href="<?php echo e(asset('css/dashboard/books.css')); ?>">
...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav style="background: url('<?php echo e(asset('assets/dashboard/images/other/nav-cover.png')); ?>') center center no-repeat !important; background-size: cover;" class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper navbar-search-wrapper d-none d-lg-flex align-items-center">
                    <form action="<?php echo e(route('books.index')); ?>" method="GET" class="d-flex align-items-center w-100">
                        ...
                        <ul class="navbar-nav navbar-nav-right d-flex align-items-center">
                            ...
                            <li class="nav-item me-2">
                                <select name="filter" class="form-control">
                                    <option value="all" <?php echo e(request('filter') == 'all' ? 'selected' : ''); ?>>Tutti i campi</option>
                                    <option value="title" <?php echo e(request('filter') == 'title' ? 'selected' : ''); ?>>Titolo</option>
                                    <option value="author" <?php echo e(request('filter') == 'author' ? 'selected' : ''); ?>>Autore</option>
                                    <option value="publisher" <?php echo e(request('filter') == 'publisher' ? 'selected' : ''); ?>>Editore</option>
                                    <option value="category" <?php echo e(request('filter') == 'category' ? 'selected' : ''); ?>>Categoria</option>
                                    <option value="isbn" <?php echo e(request('filter') == 'isbn' ? 'selected' : ''); ?>>ISBN</option>
                                    <option value="keyword" <?php echo e(request('filter') == 'keyword' ? 'selected' : ''); ?>>Parola chiave</option>
                                </select>
                            </li>
                            ...
                            <li class="nav-item ms-2">
                                <div class="my-3">
                                    <a href="<?php echo e(route('books.index')); ?>" class="btn btn-secondary btn-lg font-weight-small">
                                        Reset
                                    </a>
                                </div>
                            </li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody id="booksTableBody">
                                                ...
                                                <tr data-book-id="<?php echo e($book->id); ?>">
                                                    <td><?php echo e($book->id); ?></td>
                                                    <td>
                                                        <img src="<?php echo e($book->cover_image ? asset('storage/' . $book->cover_image) : asset('storage/covers/default.jpg')); ?>" 
                                                    ...
                                                    <td>
                                                        <span class="badge badge-info"><?php echo e($book->category->name); ?></span>
                                                    </td>
                                                    <td><?php echo e($book->year ?? '-'); ?></td>
                                                    <td>
                                                        <span class="badge badge-secondary"><?php echo e($book->copies_count); ?></span>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-success"><?php echo e($book->available_copies_count); ?></span>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-warning"><?php echo e($book->reserved_copies_count); ?></span>
                                                    </td>
                                                    <td>
                                                        <button class="btn btn-sm btn-warning" onclick="editBook(<?php echo e($book->id); ?>)" title="Modifica libro">
                                                            <i class="mdi mdi-pencil"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-info" onclick="manageCopies(<?php echo e($book->id); ?>)" title="Gestisci copie">
                                                            <i class="mdi mdi-book-multiple"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-danger" onclick="deleteBook(<?php echo e($book->id); ?>)" title="Elimina libro">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" id="bookYear" name="year" min="1000" max="<?php echo e(date('Y') + 1); ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="text-center">
                                                        <div id="coverPreview" class="mb-2" style="min-height: 200px; border: 2px dashed #ddd; border-radius: 8px; padding: 10px;">
                                                            <img id="coverImage" src="<?php echo e(asset('images/default-book-cover.png')); ?>" alt="Copertina" style="max-width: 100%; max-height: 200px; object-fit: cover;">
                                                        </div>
    ...
    <script>
        ...
        // URL helper Laravel
        const storeBookUrl = "<?php echo e(route('books.store')); ?>";
        const editBookUrlBase = "<?php echo e(url('books')); ?>";
        const updateBookUrlBase = "<?php echo e(url('books')); ?>";
        const deleteBookUrlBase = "<?php echo e(url('books')); ?>";
        const getCopiesUrlBase = "<?php echo e(url('books')); ?>";
        const storeCopyUrlBase = "<?php echo e(url('books')); ?>";
        const updateCopyUrlBase = "<?php echo e(url('books')); ?>";
        const deleteCopyUrlBase = "<?php echo e(url('books')); ?>";
        ...
        function openCreateBookModal() {
            ...
            $('#coverImage').attr('src', '<?php echo e(asset("images/default-book-cover.png")); ?>');
            $('#removeCoverBtn').hide();
...
<?php /**PATH /var/www/resources/views/dashboard/pages/books.blade.php ENDPATH**/ ?>