        ...
        <div class="row mb-4" data-aos="fade-up">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?php echo e(route('showcase.index')); ?>" class="btn btn-outline-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php if($reservations->isEmpty()): ?>
                            ...
                            <div class="text-center py-5">
                                ...
                                <a href="<?php echo e(route('showcase.index')); ?>" class="btn btn-primary mt-3">
                                    Sfoglia il Catalogo
                                </a>
                            </div>
                        <?php else: ?>
                            
                            <h4 class="card-title mb-4">Riepilogo Prenotazioni (<?php echo e($reservations->count()); ?>)</h4>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="fw-bold">#<?php echo e($reservation->id); ?></td>
                                            
                                            <td>
                                                <div>
                                                    <strong><?php echo e($reservation->bookCopy->book->title); ?></strong>
                                                    <br>
                                            ...
                                            <td>
                                                <code class="bg-light p-1 rounded"><?php echo e($reservation->bookCopy->barcode); ?></code>
                                            </td>
                                            
                                            <td>
                                                <span class="badge bg-info text-dark">
                                                    <?php echo e($reservation->bookCopy->book->category->name ?? 'N/A'); ?>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <span class="badge bg-<?php echo e($conditionClass); ?>"><?php echo e($conditionText); ?></span>
                                            </td>
                                            ...
                                            <td><?php echo e($reservation->due_date->format('d/m/Y')); ?></td>
                                            ...
                                            <td>
                                                <?php if($reservation->status === 'active'): ?>
                                                    ...
                                                    ?>
                                                    <span class="badge bg-<?php echo e($daysLeftClass); ?>">
                                                        <?php if($daysLeft < 0): ?>
                                                            Scaduta (<?php echo e(abs($daysLeft)); ?> gg)
                                                        <?php elseif($daysLeft == 0): ?>
                                                            Scade oggi
                                                        <?php else: ?>
                                                            <?php echo e($daysLeft); ?> giorni
                                                        <?php endif; ?>
                                                    </span>
                                                <?php else: ?>
...
</html><?php /**PATH /var/www/resources/views/showcase/pages/my-reservations.blade.php ENDPATH**/ ?>